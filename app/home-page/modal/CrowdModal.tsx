        ...
        <div className="bg-white bottom-0 h-4/5 w-full rounded-t-xl px-5">
          ...
          <div className="h-full pb-20 overflow-y-scroll no-scroll">
            ...
            <p className="font-bold text-xs mt-2">
              we need 50 people to vote for this entry before we can create a
              crowdfund project for it.
            </p>
            ...
            <div className="flex gap-2 mt-5">
              <button className="outline-none border-2 border-green-700 font-bold w-full rounded-full p-2 hover:bg-green-700 hover:text-white">
                Share
              </button>
              <Link
                href="/home-page/crowdfund-page/contribute"
                className="outline-none border-2 border-green-700 text-center font-bold w-full rounded-full p-2 hover:bg-green-700 hover:text-white"
              >
                Contribute
              </Link>
            </div>
